...
use Fengsha\Utils\Log\Handlers\MonologHandler;
use Fengsha\Utils\Log\Handlers\BaseHandler;
    ...
    public static function getInstance($category = 'local')
    {
        ...
        switch ($driver) {
            ...
            case 'base':
                ...
                break;
            default:
                throw new FsLogInvalidArgumentException("Unsupported driver [{$driver}]");
                break;
        }
        return $handler;
    }
